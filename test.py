...
╚══════╝░╚════╝░░╚════╝░╚═╝░░╚═╝╚══════╝╚═════╝░
    ...
    f"""
{O}╔═════════════════════════════════════════════════════════════════════════════╗
{O}║{M} [+{M}] {P}Author  {M} : {P}Ai-Lockers             {O} ║ {M} [+{M}]{P} WhatsApp {M} : {P}+33758431882   {O}   ║
{O}║{M} [+{M}] {P}Telegram{M} : {P}t.me/Ai-Lockers          {O}║{M}  [+{M}] {P}Instagram {M}: {P}pstar7.dev        {O}  ║
{O}║ {M}[+{M}] {P}Github   {M}: {P}github.com/Ai-Lockers {O}  ║{M}  [+{M}] {P}YouTube   {M}:{P} @Ai-Lockers       {O}    ║
{O}╚═════════════════════════════════════════════════════════════════════════════╝
{O}║                                    {M}Menu{O}                                     ║
{O}╔═════════════════════════════════════════════════════════════════════════════╗
...
{O}╚═════════════════════════════════════════════════════════════════════════════╝
        """)
    while True:
        choice = input(f"""{M}┌───({P}{username_pc}Ai-Lockers{M})─[{P}~{M}] 
└──{P}$ {reset}""") 